...
KC_TRNS, KC_A, KC_S, KC_D, KC_F, KC_G,  KC_H, KC_J, KC_K, KC_L, KC_P, KC_TRNS,
KC_TRNS, KC_Z, KC_X, KC_C, KC_V, KC_B,  KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_TRNS,
TD(TD_LGUI_LCTRL), KC_BSPC, KC_LSFT,               TD(TD_RALT_LALT), KC_SPC, TD(TD_LCTRL_LGUI)
    ),
...
KC_LGUI, KC_BSPC, KC_LSFT,             KC_RALT, KC_F11, KC_F12
    ),
};
...
const uint16_t PROGMEM nums[] = {KC_BSPC, KC_SPC, COMBO_END};
